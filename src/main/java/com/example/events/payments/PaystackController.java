...
public class PaystackController {
    ...
    @PostMapping("/initialize/{ticketId}")
    public ResponseEntity<?> initializeTransaction(@RequestBody PaymentRequest request,@PathVariable UUID ticketId) {
        try {
            Map<String, Object> response = paystackService.initializeTransaction(request,ticketId);
